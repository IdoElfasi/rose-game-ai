...
def check_corner(world, pos, xAdjaster):
    ...
    if f in [obstacles.TRASH, obstacles.BIKE, obstacles.BARRIER, obstacles.NONE] and fx in [obstacles.NONE,
                                                                                            obstacles.PENGUIN] and ff in [
        obstacles.TRASH, obstacles.BIKE, obstacles.BARRIER, obstacles.NONE] and ffx in [obstacles.NONE, obstacles.WATER,
                                                                                        obstacles.CRACK,
                                                                                        obstacles.PENGUIN]: return actions.RIGHT if xAdjaster == "r" else actions.LEFT
    if f in bad:
...
def check_center(world, pos):
    ...
    if fr in badmove: possible.remove(actions.RIGHT)
